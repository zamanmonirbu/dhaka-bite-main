    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-2 ">
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow space-y-4">
        ...
        {!isAuthenticated && (
          <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              Please <span className="font-semibold cursor-pointer text-blue-600 hover:underline" onClick={() => router.push("/login")}>login</span> to continue with your order.
            </p>
          </div>
        )}
        ...
        <input 
          ...
          className={`w-full input-style ${!isAuthenticated ? 'input-disabled' : ''}`}
        ...
        {showMap && selectedArea && isAuthenticated && (
